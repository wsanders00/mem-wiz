...
The example tag in this document is `v0.1.0`, but use the next SimVer value for
the actual release.
...
7. Create and push the release tag, for example `git tag v0.1.0` followed by `git push origin v0.1.0`.
